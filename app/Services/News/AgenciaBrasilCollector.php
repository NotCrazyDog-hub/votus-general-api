...
class AgenciaBrasilCollector
{
     ...
     *
     * @return array<int, array{title:string,url:string,conteudo_original:string,published_at:?string,image_url:?string,category:?string}>
     */
    public function coletar(string $feedUrl): array
    {
        ...
        foreach ($xml->channel->item as $item) {
            ...
            $itens[] = [
                ...
                'url' => $link,
                'conteudo_original' => trim((string) $item->description),
