...
/*
|--------------------------------------------------------------------------
| Content & Publications (News, Proposals, Categories)
|--------------------------------------------------------------------------
*/
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'admin'])->group(function () {
        ...
        Route::get('/suggestions', [Admin\SuggestionController::class, 'index']);
        Route::post('/suggestions', [Admin\SuggestionController::class, 'store'])->middleware('throttle:20,1');
